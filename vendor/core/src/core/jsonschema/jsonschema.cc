...
auto uri_to_known_vocabulary(std::string_view uri) -> std::optional<sourcemeta::core::KnownVocabulary> {
  using sourcemeta::core::KnownVocabulary;

  // Pre-vocabulary dialects
  if (uri == "http://json-schema.org/draft-00/schema#") return KnownVocabulary::Draft00;
  if (uri == "http://json-schema.org/draft-01/schema#") return KnownVocabulary::Draft01;
  if (uri == "http://json-schema.org/draft-01/hyper-schema#") return KnownVocabulary::Draft01;
  if (uri == "http://json-schema.org/draft-02/hyper-schema#") return KnownVocabulary::Draft02;
  if (uri == "http://json-schema.org/draft-03/schema#") return KnownVocabulary::Draft03;
  if (uri == "http://json-schema.org/draft-03/hyper-schema#") return KnownVocabulary::Draft03Hyper;
  if (uri == "http://json-schema.org/draft-04/schema#") return KnownVocabulary::Draft04;
  if (uri == "http://json-schema.org/draft-04/hyper-schema#") return KnownVocabulary::Draft04Hyper;
  if (uri == "http://json-schema.org/draft-06/schema#") return KnownVocabulary::Draft06;
  if (uri == "http://json-schema.org/draft-06/hyper-schema#") return KnownVocabulary::Draft06Hyper;
  if (uri == "http://json-schema.org/draft-07/schema#") return KnownVocabulary::Draft07;
  if (uri == "http://json-schema.org/draft-07/hyper-schema#") return KnownVocabulary::Draft07Hyper;

  // 2019-09 vocabularies
  if (uri == "https://json-schema.org/draft/2019-09/vocab/core") return KnownVocabulary::Draft201909Core;
  if (uri == "https://json-schema.org/draft/2019-09/vocab/applicator") return KnownVocabulary::Draft201909Applicator;
  if (uri == "https://json-schema.org/draft/2019-09/vocab/validation") return KnownVocabulary::Draft201909Validation;
  if (uri == "https://json-schema.org/draft/2019-09/vocab/meta-data") return KnownVocabulary::Draft201909MetaData;
  if (uri == "https://json-schema.org/draft/2019-09/vocab/format") return KnownVocabulary::Draft201909Format;
  if (uri == "https://json-schema.org/draft/2019-09/vocab/content") return KnownVocabulary::Draft201909Content;
  if (uri == "https://json-schema.org/draft/2019-09/vocab/hyper-schema") return KnownVocabulary::Draft201909HyperSchema;

  // 2020-12 vocabularies
  if (uri == "https://json-schema.org/draft/2020-12/vocab/core") return KnownVocabulary::Draft202012Core;
  if (uri == "https://json-schema.org/draft/2020-12/vocab/applicator") return KnownVocabulary::Draft202012Applicator;
  if (uri == "https://json-schema.org/draft/2020-12/vocab/unevaluated") return KnownVocabulary::Draft202012Unevaluated;
  if (uri == "https://json-schema.org/draft/2020-12/vocab/validation") return KnownVocabulary::Draft202012Validation;
  if (uri == "https://json-schema.org/draft/2020-12/vocab/meta-data") return KnownVocabulary::Draft202012MetaData;
  if (uri == "https://json-schema.org/draft/2020-12/vocab/format-annotation") return KnownVocabulary::Draft202012FormatAnnotation;
  if (uri == "https://json-schema.org/draft/2020-12/vocab/format-assertion") return KnownVocabulary::Draft202012FormatAssertion;
  if (uri == "https://json-schema.org/draft/2020-12/vocab/content") return KnownVocabulary::Draft202012Content;
...
auto sourcemeta::core::Vocabularies::contains(std::string_view uri) const -> bool {
  ...
  if (maybe_known.has_value()) {
    ...
    // Check if enabled and not explicitly disabled
...
auto sourcemeta::core::Vocabularies::insert(const std::pair<JSON::String, bool>& entry) -> void {
...
auto sourcemeta::core::Vocabularies::find(std::string_view uri) const -> std::optional<bool> {
  const auto maybe_known = uri_to_known_vocabulary(uri);
  if (maybe_known.has_value()) {
    const auto flag = static_cast<uint32_t>(maybe_known.value());
    if ((enabled_known & flag) != 0) return true;
    if ((disabled_known & flag) != 0) return false;
    return std::nullopt;
  }
  // Fallback to custom vocabularies
  const auto it = custom.find(std::string{uri});
...
auto sourcemeta::core::Vocabularies::merge(const Vocabularies& other) -> void {
  // Merge bitflags
  enabled_known |= other.enabled_known;
  disabled_known |= other.disabled_known;
...
auto sourcemeta::core::Vocabularies::all_vocabularies() const -> std::vector<std::pair<std::string, bool>> {
  ...
  check_and_add(KnownVocabulary::Draft02, "http://json-schema.org/draft-02/hyper-schema#");
